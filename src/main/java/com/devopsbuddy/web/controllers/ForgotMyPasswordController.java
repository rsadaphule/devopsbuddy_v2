...
public class ForgotMyPasswordController {
    ...
    public static  final  String EMAIL_ADDRES_VIEW_NAME = "forgotmypassword/emailForm";
    ...
    public static  final String CHANGE_PASSWORD_VIEW = "forgotmypassword/changepassword";
    ...
    {
        return EMAIL_ADDRES_VIEW_NAME;
    }


    @RequestMapping(value=FORGOT_PASSWORD_URL_MAPPING, method = RequestMethod.POST)
    public String forgotmyPasswordPost(HttpServletRequest request,
                                       @RequestParam("email") String email,
                                       ModelMap model)
    {

        PasswordResetToken pwr = passwordResetTokenService.createPasswordResetTokenForEmail(email);
        if(null == pwr)
        {
        ...
        {
            User user = pwr.getUser();
            String token = pwr.getToken();
